...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    id: "designcn",
    title: "DesignCN",
    image: "/projects/designcn.png",
    github: "https://github.com/Berget1411/designcn",
    demo: "https://designcn.bergstromlabs.com",
    tech: [
      "TypeScript",
      "Next.js",
      "React",
    ...
    devMode: true,
    shortDescription:
      "AI-powered design platform with collaborative tools, drag-and-drop interfaces, and AI-driven workflows.",
    longDescription:
      "DesignCN is an AI-powered design platform built on a modern monorepo stack. It features collaborative design tools with drag-and-drop interfaces, real-time capabilities, and AI-powered functionality via Mastra and OpenAI integration. The frontend is a Next.js application with shadcn/ui components, multiple icon libraries, and state management through Zustand and Jotai. The backend runs on Cloudflare Workers with tRPC for type-safe APIs, Drizzle ORM with PostgreSQL, and Better-Auth for authentication. Includes a separate studio app for design features deployed to Cloudflare Pages.",
    date: "Apr, 2026",
  },
  {
    isFeatured: true,
    id: "openbook",
    title: "OpenBook",
    image: "/projects/openbook.png",
    demo: "https://openbook.bergstromlabs.com",
    tech: [
      "TypeScript",
      "React",
      "TanStack Router",
    ...
    devMode: true,
    shortDescription:
      "AI-powered accounting SaaS for Swedish small businesses. Automates bookkeeping, VAT returns, and financial reporting.",
    longDescription:
      "OpenBook is an AI-powered accounting platform built for Swedish small businesses (Aktiebolag). It features a financial inbox that aggregates bank transactions, receipts, and invoices, with AI that automatically drafts journal entries from bank feeds and receipt OCR. Users approve with one click, and the system auto-generates VAT returns (e-SKD XML) and financial reports. Modules include Dashboard, Inbox, Tracker, Vault, Invoices, Expenses, Bank, and Taxes & Reports. Built on a Turborepo monorepo with a React frontend using TanStack Router, a Hono + tRPC backend on Cloudflare Workers, Mastra for AI workflows, and Drizzle ORM with PostgreSQL.",
    date: "Apr, 2026",
  },
  {
    isFeatured: true,
